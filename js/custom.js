           ...
           if ($("#jquery_jplayer_4").length > 0) {
             ...
             if(proposal==="HITS"){
              thispage_name = tag_name[6];
               ...
               $.getJSON( "json/tf-idf-7-09-1.json")
                .done(function( data ) {
                  vedioinfo_process(data);
                  setinitialShift();
              ...
              if ($("#jquery_jplayer_5").length > 0) {
                ...
                if(proposal==="HITS"){
                 thispage_name = tag_name[8];
                  ...
                  $.getJSON( "json/tf-idf-7-09-2.json")
                   .done(function( data ) {
                     vedioinfo_process(data);
                     setinitialShift();
